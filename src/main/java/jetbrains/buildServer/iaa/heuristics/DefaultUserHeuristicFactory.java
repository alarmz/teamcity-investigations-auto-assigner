...
@Component
public class DefaultUserHeuristicFactory implements HeuristicFactory {

  @NotNull private final UserModelEx myUserModel;

  public DefaultUserHeuristicFactory(@NotNull final UserModelEx userModel) {
  ...
  public Heuristic createHeuristic(final SBuild sBuild,
    ...
    return new DefaultUserHeuristic(myUserModel, sBuild);
  }
}
